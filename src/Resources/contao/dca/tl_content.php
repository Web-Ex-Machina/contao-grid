...
$GLOBALS['TL_DCA']['tl_content']['subpalettes']['grid_mode_'.GridStart::MODE_AUTOMATIC] = '';
...
$GLOBALS['TL_DCA']['tl_content']['fields']['grid_mode'] = [
    ...
    'inputType' => 'select',
    'options' => [
        GridStart::MODE_AUTOMATIC => &$GLOBALS['TL_LANG']['tl_content']['grid_mode']['automatic'],
        GridStart::MODE_CUSTOM => &$GLOBALS['TL_LANG']['tl_content']['grid_mode']['custom'],
    ],
    'default' => GridStart::MODE_AUTOMATIC,
    'eval' => ['submitOnChange' => true, 'tl_class' => 'clr'],
    'sql' => "varchar(9) NOT NULL default '".GridStart::MODE_CUSTOM."'", // for backward compatibility on all existing grids
];
